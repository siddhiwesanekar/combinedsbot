...
parent_classes1 = data['parent_classes']
...
net1 = tflearn.input_data(shape=[None, len(train_x1[0])])
net1 = tflearn.fully_connected(net1, 10)
net1 = tflearn.fully_connected(net1, 10)
net1 = tflearn.fully_connected(net1, len(train_y1[0]), activation='softmax')
...
def clean_up_sentence(sentence):
    ...
    # stem each word
    sentence_words = [stemmer1.stem(word.lower()) for word in sentence_words]
...
def classify(sentence):
    ...
    results = model1.predict([bow(sentence, words1)])[0]
    ...
    return_list = []
    for r in results:
        return_list.append((classes1[r[0]], r[1]))
...
def response(sentence, userID='123', show_details=False):
    ...
    if sentence in parent_classes1:
